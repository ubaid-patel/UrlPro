    ...
    return (
        <>
            <div className={"userLink Desktop "}>
                            ...
                            <td style={{position:"relative"}}>
                                <button className={"actbtn menu" + link.endpoint} onClick={() => {
                                    ...
                                    for (let i = 0; i < moreopts.length; i++) {
                                        if (moreopts[i].classList.contains('showOpts')) {
                                            moreopts[i].classList.remove("showOpts");
                                            moreopts[i].classList.add("hideOp");
                                        } else {
                                            moreopts[i].classList.remove("hideOp");
                                            moreopts[i].classList.add("showOpts");
                                        }
                                    }
                                }}>
                ...
                {/** infocard to be displayed on mobile devices**/}
